define(
  ...
  function (
    ...
    return Component.extend({
      defaults: {
        template: {
          name: 'Pmclain_Stripe/payment/form',
          afterRender: function (renderedDom, data) {
            data.validateCard()
          }
        },
        stripe: null,
      ...
      validateCard: function() {
        jQuery('[data-name="cardNumber"]').each(function() {
          new Cleave(this, {
            creditCard: true,
        ...
        jQuery('[data-name="cardExpiry"]').each(function() {
          new Cleave(this, {
            date: true,
            datePattern: ['m', 'y']
          });
        ...
        jQuery('[data-name="cardCVC"]').each(function() {
          new Cleave(this, {
            numeral: true,
